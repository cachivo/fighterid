-- Remove ELO rating columns from fighter_profiles table
ALTER TABLE public.fighter_profiles DROP COLUMN IF EXISTS elo_rating;

-- Remove ELO rating columns from fight_results table
...
-- Update any functions that reference ELO rating
-- Update the import_fighter_data function to remove ELO calculation
...
BEGIN
  ...
  -- Determine weight class (based on pounds for MMA)
  CASE 
