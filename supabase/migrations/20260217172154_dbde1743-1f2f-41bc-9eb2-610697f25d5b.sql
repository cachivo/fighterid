...
-- Rewrite check_user_license_status to be simpler and correct
-- The key fix: use primary_license_id from fighter_profiles as source of truth
...
BEGIN
  ...
  -- 3) Find license - prioritize primary_license_id from profile (source of truth)
  ...
  -- 4) Fallback: search by fighter_id if primary_license_id didn't work
