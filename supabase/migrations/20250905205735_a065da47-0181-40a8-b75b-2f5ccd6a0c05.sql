-- Fix the discipline type conversion error in admin_update_fighter_profile_v3
...
BEGIN
  ...
  SET 
    ...
    -- Fixed discipline handling - no type conversion conflict
    discipline = CASE 
      WHEN p_profile_data ? 'discipline' 
        ...
        (p_profile_data->>'discipline')::text::discipline_type
      ELSE discipline
    END,
