-- Limpieza sin eliminar perfiles referenciados por otras tablas
...
-- Paso 2: Desactivar perfiles huérfanos en lugar de eliminarlos
UPDATE public.fighter_profiles 
SET active = false
...
-- Paso 5: Crear función de sincronización automática
...
-- Paso 6: Crear trigger y constraints
