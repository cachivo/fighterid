...
DECLARE
  ...
  v_license record;
BEGIN
  SELECT id, email, phone INTO v_app_user_id, v_app_email, v_app_phone
  FROM app_user
  ...
  BEGIN
    v_profile_json := jsonb_build_object(
      ...
      'wins', v_profile.record_wins,
      'losses', v_profile.record_losses,
      'draws', v_profile.record_draws,
      'birthdate', v_profile.birthdate,
      'height_cm', v_profile.height_cm,
      'reach_cm', v_profile.reach_cm,
      'coach_id', v_profile.coach_id,
      -- Campos anteriormente faltantes
      'gender', v_profile.gender,
      'birthplace', v_profile.birthplace,
      'blood_type', v_profile.blood_type,
      'weight_kg', v_profile.weight_kg,
      'fighting_style', v_profile.fighting_style,
      'level', v_profile.level,
      'record_type', v_profile.record_type,
      'bio', v_profile.bio,
      'emergency_contact_name', v_profile.emergency_contact_name,
      'emergency_contact_phone', v_profile.emergency_contact_phone,
      'emergency_contact_relation', v_profile.emergency_contact_relation,
      'medical_conditions', v_profile.medical_conditions,
      'medical_allergies', v_profile.medical_allergies,
      'insurance_company', v_profile.insurance_company,
      'insurance_policy', v_profile.insurance_policy,
      'boxrec_url', v_profile.boxrec_url,
      'tapology_url', v_profile.tapology_url,
      'document_type', v_profile.document_type,
      'document_number', v_profile.document_number,
      'document_image_url', v_profile.document_image_url,
      'martial_arts', v_profile.martial_arts,
      'mma_record_wins', v_profile.mma_record_wins,
      'mma_record_losses', v_profile.mma_record_losses,
      'mma_record_draws', v_profile.mma_record_draws,
      'boxeo_record_wins', v_profile.boxeo_record_wins,
      'boxeo_record_losses', v_profile.boxeo_record_losses,
      'boxeo_record_draws', v_profile.boxeo_record_draws,
      'phone', v_app_phone
    );
