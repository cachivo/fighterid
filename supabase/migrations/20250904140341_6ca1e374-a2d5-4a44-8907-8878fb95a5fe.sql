...
-- Corrigiendo valores de license_status para usar solo valores permitidos
...
SET license_number = NULL,
    ...
    license_status = 'active'  -- Usar valor permitido por el constraint
WHERE active = true;
...
SET 
  ...
  license_status = CASE 
    ...
    ELSE 'active'  -- Default a 'active' en lugar de 'pending'
  END,
...
BEGIN
  ...
  IF TG_OP = 'DELETE' THEN
    ...
    SET 
      ...
      license_issued_date = NULL,
      license_expires_date = NULL,
      license_status = 'active',  -- Mantener 'active' como default
